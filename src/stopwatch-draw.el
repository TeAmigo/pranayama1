...
(defconst STOPWATCH-RUNNING-INSTRUCTIONS
  "Press 'q' to quit, 's' to stop/start, 'l' to finish a lap, 'e' goto recording buffer")
(defconst STOPWATCH-STOPPED-INSTRUCTIONS
  "Press 'q' to quit, 's' to start stopwatch, 'r' to reset, 'e' goto recording buffer")
